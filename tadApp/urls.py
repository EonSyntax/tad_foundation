...
urlpatterns = [
    ...
    path('upcomingprojectdetail', views.upcomingprojectdetail, name='upcomingprojectdetail'),
    path('completedprojectdetail', views.completedprojectdetail, name='completedprojectdetail'),
